...
router.get('/password/valid' , resetPasswordController.showvalidcode);
router.post('/password/valid' , resetPasswordValidator.handle() , resetPasswordController.resetPasswordProccess);
